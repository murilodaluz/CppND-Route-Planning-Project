...
```
git clone https://github.com/murilodaluz/CppND-Route-Planning-Project.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:murilodaluz/CppND-Route-Planning-Project.git --recurse-submodules
```
